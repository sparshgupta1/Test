...
DRV_USART_DYN_CONFIG_DATA usart2Config =
{
    .baud = DRV_USART_BAUD_RATE_IDX1,
    .linectrl = USART_8N1,
    .handshake = USART_HANDSHAKE_MODE_SIMPLEX,
 ...
 */
DRV_USART_FUNCTIONAL_TEST_BASIC_WR_INIT_DATA testDrvUsartFuncInitDataSet1 =
{
    ...
    /* Test case pointer */
    .tsUsartBasicWR = &usartBasicWRTestcase[0],
...
{
    {
        ...
        .initialize = APP_TestDrvUsartBasicWRFuncInitialize,
        .tasks      = {
                        APP_TestDrvUsartBasicFuncTasks1,
                        APP_TestDrvUsartBasicFuncTasks2,
                      },
        .start      = APP_TestDrvUsartBasicWRFuncStart,
        .status     = APP_TestDrvUsartBasicWRFuncStatus,
        .index      = 0,
