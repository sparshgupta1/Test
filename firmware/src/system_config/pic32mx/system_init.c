 ...
 */
DRV_USART_DYN_CONFIG_DATA usart1Config =
{
    .baud = DRV_USART_BAUD_RATE_IDX0,
    .linectrl = USART_8N1,
    .handshake = USART_HANDSHAKE_MODE_SIMPLEX,
};

/* 
 * USART Initialization Data
 */
DRV_USART_FUNCTIONAL_TEST_BASIC_WRITE_INIT_DATA testDrvUsartFuncInitDataSet1 =
{
    /* DRV module init data */
    .modulesInitData =
    {
        (DRV_USART_INIT *) &drvUsart0InitData
    },
    ...
    /* Test case pointer */
    .tsUsartBasicWrite = &usartBasicWriteTestcase[0],

};

DRV_USART_FUNCTIONAL_TEST_BASIC_READ_INIT_DATA testDrvUsartFuncInitDataSet2 =
{
    .modulesInitData =
    {
        (DRV_USART_INIT *) &drvUsart0InitData
    ...
    /* Test case pointer */
    .tsUsartBasicRead = &usartBasicReadTestcase[0],
};

/* Library Under Test Data */
static LIBRARY_UNDER_TEST mutDrvUsart1 = 
{
...
{
    {
        .name       = "USART Sample Test Scenario 1",
        .initialize = APP_TestDrvUsartBasicWriteFuncInitialize,
        .tasks      = {
                        APP_TestDrvUsartBasicWriteFuncTasks,
                      },
        .start      = APP_TestDrvUsartBasicWriteFuncStart,
        .status     = APP_TestDrvUsartBasicWriteFuncStatus,
        .index      = 0,
        .initData   = (SYS_MODULE_INIT *)&testDrvUsartFuncInitDataSet1,
        .library    = &mutDrvUsart1,      
    },
    {
        .name       = "USART Sample Test Scenario 2",
        .initialize = APP_TestDrvUsartBasicReadFuncInitialize,
        .tasks      = {
                        APP_TestDrvUsartBasicReadFuncTasks,
                      },
        .start      = APP_TestDrvUsartBasicReadFuncStart,
        .status     = APP_TestDrvUsartBasicReadFuncStatus,
        .index      = 0,
        .initData   = (SYS_MODULE_INIT *)&testDrvUsartFuncInitDataSet2,
        .library    = &mutDrvUsart1
    }
};
