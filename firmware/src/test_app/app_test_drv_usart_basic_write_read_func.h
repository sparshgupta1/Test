/*******************************************************************************
  ...
  File Name:
    app_test_drv_usart_basic_write_read_func.h
...
#ifndef _TEST_DRV_USART_BASIC_WRITE_READ_MODULE_H
#define _TEST_DRV_USART_BASIC_WRITE_READ_MODULE_H
...
}TS_DRV_USART_BASIC_WR;

typedef struct _drv_usart_module_test_basic_wr_init_data
{
    ...
    TS_DRV_USART_BASIC_WR    * tsUsartBasicWR;

} DRV_USART_FUNCTIONAL_TEST_BASIC_WR_INIT_DATA;
...
extern TS_DRV_USART_BASIC_WR usartBasicWRTestcase[];

#endif /* _TEST_DRV_USART_BASIC_WRITE_READ_MODULE_H */
/*******************************************************************************
 End of File
 */
