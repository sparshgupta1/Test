/*******************************************************************************
  ...
  File Name:
    app_test_drv_usart_basic_write_func.h
...
#ifndef _TEST_DRV_USART_BASIC_WRITE_MODULE_H
#define _TEST_DRV_USART_BASIC_WRITE_MODULE_H
...
}TS_DRV_USART_BASIC_WRITE;

typedef struct _drv_usart_module_test_basic_write_init_data
{
    ...
    TS_DRV_USART_BASIC_WRITE   * tsUsartBasicWrite;
        
} DRV_USART_FUNCTIONAL_TEST_BASIC_WRITE_INIT_DATA;
...
/*******************************************************************************
  ...
  Summary:
    MPLAB Harmony USART driver functional test tasks function

  Description:
    This routine is the USART driver functinoal test tasks function.  It
...
extern TS_DRV_USART_BASIC_WRITE usartBasicWriteTestcase[];

#endif /* _TEST_DRV_USART_BASIC_WRITE_MODULE_H */
/*******************************************************************************
 End of File
 */
